...
class CalClock {
  ...
  calhtml(d) {
    return `<span><span class="calclock weekday">${d.weekday.long}</span>,<span class="calclock month"> ${d.monthstr}</span><span class="calclock day"> ${d.day}</span><span class="calclock year"> ${d.year}</span></span>`;
  }
  clockhtml(d) {
